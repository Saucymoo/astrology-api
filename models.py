...
class BirthInfoRequest(BaseModel):
    ...
    timezone: Optional[float] = Field(None, ge=-12, le=14, description="Timezone offset in hours")
    ...
    def validate_time(cls, v):
        ...
        try:
            ...
            raise ValueError('Time must be in HH:MM format (24-hour) and be a valid time')
...
class House(BaseModel):
    ...
    sign_num: int = Field(..., ge=1, le=12, description="Sign number (1-12)")
    degree: float = Field(..., ge=0, lt=360, description="Degree of house cusp")
...
class AstrologyResponse(BaseModel):
    ...
    birth_info: BirthInfoRequest = Field(..., description="Original birth information")
