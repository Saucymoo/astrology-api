    ...
    try:
        ...
        for planet in raw_chart.planets:
            ...
            placement = {
                ...
                "sign": planet.sign,
                "degree": degree,
                "exact_degree": f"{int(degree)}°{int((degree % 1) * 60):02d}'{int(((degree % 1) * 60 % 1) * 60):02d}\"",
                "house": house,
        ...
        mc_sign_index = (rising_index + 9) % 12
        ...
        response = {
            ...
            "ascendant": {
                "sign": rising_sign,
                "degree": asc_degree,
                "exact_degree": f"{int(asc_degree)}°{int((asc_degree % 1) * 60):02d}'{int(((asc_degree % 1) * 60 % 1) * 60):02d}\""
            },
            "midheaven": {
                "sign": mc_sign,
                "degree": 15.0,
